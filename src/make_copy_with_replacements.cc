...
void chomik::expand_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
    target = std::make_shared<expand_statement>(depth, line_number);
}

void chomik::execute_value_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
...
void chomik::type_definition_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
    target = std::make_shared<type_definition_statement>(line_number);
}

void chomik::variable_definition_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
    target = std::make_shared<variable_definition_statement>(line_number);
}

void chomik::execute_variable_value_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
...
void chomik::assignment_statement::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::shared_ptr<statement> & target) const
{
...
void chomik::generic_literal_placeholder::make_copy_with_replacements(const machine & m, const basic_generator & g, const replacing_policy & p, std::unique_ptr<generic_literal> & target) const
{
